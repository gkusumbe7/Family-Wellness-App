import myImage from '../assets/familywellness.webp';
       ...
       <div className="m-5 flex flex-col gap-4">
        ...
        <center className=""> 
            <div className="w-4/5 bg-pink-400 p-10 space-y-5">
                ...
                <p className="text-md text-wrap">We are open 9am to 6pm, Monday through Sunday. if you would like to schedule an appointment with us,
                    please call us at 987-854-3210 today!
                </p>
                <div>
                    <button className="border p-2 mx-1">LEARN MORE ABOUT US</button>
                    <button className="border p-2 mx-1">CONTACT US TODAY</button>
                </div>
            </div>
        </center>
        <center className=""> 
